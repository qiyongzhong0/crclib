...
#include <rtdbg.h>
#include <string.h>
#if (defined(CHIP_SERIES_N32G452) || defined(CHIP_SERIES_N32G455) ||           \
     defined(CHIP_SERIES_N32G457))
#include <n32g45x.h>
#endif
...
void crc_hw_init(crc_hw_inst_t *hinst, u32 poly) {
  ...
  if (poly == 0xEDB88320) // CRC32 only support poly = x32+x26+x23+...+x2+x+1
  ...
  LOG_E("The polynomial is not support. The polynomial must is 0xA001 or "
        "0xEDB88320");
}
