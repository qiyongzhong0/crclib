...
// #define CRC8_USING_CONST_TABLE //using const table in flash memory, nodefined
// using table in ram
#ifndef CRC8_POLY
...
// #define CRC16_USING_CONST_TABLE //using const table in flash memory,
// nodefined using table in ram
#ifndef CRC16_POLY
#define CRC16_POLY 0xA001 // crc16 polynome, Poly = x16+x15+x2+1 (IBM,SDLC)
// #define CRC16_POLY      0x8408 //crc16 polynome, Poly = x16+x12+x5+1
// (CCITT,ISO,HDLC,ITUX25,PPP-FCS)
#endif
...
// #define CRC32_USING_CONST_TABLE //using const table in flash memory,
// nodefined using table in ram
#ifndef CRC32_POLY
#define CRC32_POLY                                                             \
  0xEDB88320 // crc32 polynome, Poly = x32+x26+x23+...+x2+x+1
             // (ZIP,RAR,IEEE,LAN/FDDI,PPP-FCS)
// #define CRC32_POLY      0x82F63B78 //crc32 polynome, Poly =
// x32+x28+x27+...+x8+x6+1 (SCTP)
#endif
